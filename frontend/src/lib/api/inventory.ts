...
function mapIndicatorDataResponse(payload: RawIndicatorDataResponse): IndicatorDataResponse {
  ...
  return {
    indicator: {
      ...
      isSeasonal: payload.indicator.is_seasonal ?? undefined,
    },
  ...
  return {
    ...
    cards: payload.cards.map((card) => {
      ...
      return {
        ...
        isSeasonal: card.is_seasonal ?? undefined,
        ...
        freshness: freshnessFor(card.frequency ?? undefined, card.last_updated_at, card.stale),
        stale: card.stale,
