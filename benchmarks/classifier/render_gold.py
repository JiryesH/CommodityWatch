#!/usr/bin/env python3
"""Render manual classifier annotations into benchmark gold JSONL."""
...
DEFAULT_SAMPLE = Path("benchmarks/classifier/sample_scaffold.jsonl")
DEFAULT_OUTPUT = Path("benchmarks/classifier/gold.jsonl")
