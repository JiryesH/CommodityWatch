#!/usr/bin/env python3
"""Render fresh holdout annotations into benchmark gold JSONL."""
...
from holdout_annotations import ANNOTATIONS


DEFAULT_SAMPLE = Path("benchmarks/classifier/holdout_sample_scaffold.jsonl")
DEFAULT_OUTPUT = Path("benchmarks/classifier/holdout_gold.jsonl")
