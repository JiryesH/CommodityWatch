#!/usr/bin/env python3
"""Render second holdout annotations into benchmark gold JSONL."""
...
from holdout2_annotations import ANNOTATIONS


DEFAULT_SAMPLE = Path("benchmarks/classifier/holdout2_sample_scaffold.jsonl")
DEFAULT_OUTPUT = Path("benchmarks/classifier/holdout2_gold.jsonl")
