#!/usr/bin/env python3
"""Render the manual annotation source into a gold JSONL benchmark file."""
...
from gold_annotations import GOLD_ANNOTATIONS


DEFAULT_SAMPLE = Path("benchmarks/ner_spacy/sample_scaffold.jsonl")
DEFAULT_OUTPUT = Path("benchmarks/ner_spacy/gold.jsonl")
...
def main() -> None:
    ...
    annotation_ids = set(GOLD_ANNOTATIONS)
    ...
    for row in rows:
        ...
        annotation = GOLD_ANNOTATIONS[article_id]
        row["gold"] = {
