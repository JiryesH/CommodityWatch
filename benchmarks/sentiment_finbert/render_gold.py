#!/usr/bin/env python3
"""Render manual sentiment annotations into the benchmark gold JSONL."""
...
from gold_annotations import ANNOTATIONS


DEFAULT_SAMPLE = Path("benchmarks/sentiment_finbert/sample_scaffold.jsonl")
DEFAULT_OUTPUT = Path("benchmarks/sentiment_finbert/gold.jsonl")
