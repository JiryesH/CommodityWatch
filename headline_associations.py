...
METALS_SERIES_ALIASES: dict[str, tuple[str, ...]] = {
    ...
    "tin_monthly": ("Tin",),
    "iron_ore_62pct_china_monthly": ("Iron Ore", "62% Fe"),
...
AGRI_SERIES_RULES: dict[str, SeriesHeadlineRule] = {
    ...
    "wheat_us_srw_monthly": SeriesHeadlineRule(
        categories=("Agriculture",),
        aliases=("Wheat", "SRW", "Soft Red Winter"),
        minimum_score=4,
        require_category_match=True,
    ),
    ...
    "barley_monthly": SeriesHeadlineRule(
        categories=("Agriculture",),
        aliases=("Barley",),
        minimum_score=3,
        require_category_match=True,
    ...
    "soybean_meal_monthly": SeriesHeadlineRule(
        categories=("Agriculture", "General"),
        aliases=("Soybean Meal",),
        minimum_score=3,
        require_category_match=True,
    ),
    ...
    "palm_kernel_oil_monthly": SeriesHeadlineRule(
        categories=("Agriculture", "General"),
        aliases=("Palm Kernel Oil",),
        minimum_score=3,
        require_category_match=True,
    ),
    "coconut_oil_monthly": SeriesHeadlineRule(
        categories=("Agriculture", "General"),
        aliases=("Coconut Oil",),
        minimum_score=3,
        require_category_match=True,
    ),
    "rapeseed_oil_monthly": SeriesHeadlineRule(
        categories=("Agriculture", "General"),
        aliases=("Rapeseed Oil", "Canola Oil"),
        minimum_score=3,
        require_category_match=True,
    ),
    "sunflower_oil_monthly": SeriesHeadlineRule(
        categories=("Agriculture", "General"),
        aliases=("Sunflower Oil",),
        minimum_score=3,
        require_category_match=True,
    ),
    "groundnuts_monthly": SeriesHeadlineRule(
        categories=("Agriculture", "General"),
        aliases=("Groundnuts", "Peanuts"),
        minimum_score=3,
        require_category_match=True,
    ),
    ...
    "rice_thai_25pct_monthly": SeriesHeadlineRule(
        categories=("Agriculture",),
        aliases=("Rice", "Thai 25%", "Thai Rice"),
        minimum_score=4,
        require_category_match=True,
    ),
    "rice_thai_a1_monthly": SeriesHeadlineRule(
        categories=("Agriculture",),
        aliases=("Rice", "Thai A.1", "Thai A1"),
        minimum_score=4,
        require_category_match=True,
    ),
    "rice_vietnam_5pct_monthly": SeriesHeadlineRule(
        categories=("Agriculture",),
        aliases=("Rice", "Vietnam 5%", "Viet Nam 5%"),
        minimum_score=4,
        require_category_match=True,
    ),
    ...
    "sugar_eu_monthly": SeriesHeadlineRule(
        categories=("Agriculture", "General"),
        aliases=("Sugar", "EU Sugar", "European Sugar"),
        minimum_score=4,
        require_category_match=True,
    ),
    "sugar_us_monthly": SeriesHeadlineRule(
        categories=("Agriculture", "General"),
        aliases=("Sugar", "US Sugar", "U.S. Sugar"),
        minimum_score=4,
        require_category_match=True,
    ),
    ...
    "bananas_europe_monthly": SeriesHeadlineRule(
        categories=("Agriculture", "General"),
        aliases=("Bananas", "Banana"),
        minimum_score=3,
        require_category_match=True,
    ),
    "bananas_us_monthly": SeriesHeadlineRule(
        categories=("Agriculture", "General"),
        aliases=("Bananas", "Banana"),
        minimum_score=3,
        require_category_match=True,
    ),
    "orange_monthly": SeriesHeadlineRule(
        categories=("Agriculture", "General"),
    ...
    "rubber_rss3_monthly": SeriesHeadlineRule(
        categories=("Agriculture", "Chemicals", "General"),
        aliases=("Rubber", "RSS3"),
        minimum_score=3,
        require_category_match=True,
    ),
    "rubber_tsr20_monthly": SeriesHeadlineRule(
        categories=("Agriculture", "Chemicals", "General"),
        aliases=("Rubber", "TSR20"),
        minimum_score=4,
        require_category_match=True,
    ),
    "beef_monthly": SeriesHeadlineRule(
        categories=("Agriculture", "General"),
        aliases=("Beef",),
        minimum_score=3,
        require_category_match=True,
    ),
    "poultry_monthly": SeriesHeadlineRule(
        categories=("Agriculture", "General"),
        aliases=("Poultry", "Chicken"),
        minimum_score=3,
        require_category_match=True,
    ),
    "lamb_monthly": SeriesHeadlineRule(
        categories=("Agriculture", "General"),
        aliases=("Lamb",),
        minimum_score=3,
        require_category_match=True,
    ),
    "swine_monthly": SeriesHeadlineRule(
        categories=("Agriculture", "General"),
        aliases=("Swine", "Pork", "Hog"),
        minimum_score=3,
        require_category_match=True,
    ),
    "shrimp_monthly": SeriesHeadlineRule(
        categories=("Agriculture", "General"),
        aliases=("Shrimp",),
        minimum_score=3,
        require_category_match=True,
    ),
    "salmon_monthly": SeriesHeadlineRule(
        categories=("Agriculture", "General"),
        aliases=("Salmon",),
        minimum_score=3,
        require_category_match=True,
    ),
    "fish_meal_monthly": SeriesHeadlineRule(
        categories=("Agriculture", "General"),
        aliases=("Fish Meal",),
        minimum_score=3,
        require_category_match=True,
    ),
    "phosphate_rock_monthly": SeriesHeadlineRule(
        categories=("Fertilizers", "Agriculture", "General"),
        aliases=("Phosphate Rock",),
        minimum_score=3,
        require_category_match=True,
    ),
    "dap_monthly": SeriesHeadlineRule(
        categories=("Fertilizers", "Agriculture", "General"),
        aliases=("DAP", "Diammonium Phosphate"),
        minimum_score=4,
        require_category_match=True,
    ),
    "tsp_monthly": SeriesHeadlineRule(
        categories=("Fertilizers", "Agriculture", "General"),
        aliases=("TSP", "Triple Superphosphate"),
        minimum_score=4,
        require_category_match=True,
    ),
    "urea_monthly": SeriesHeadlineRule(
        categories=("Fertilizers", "Agriculture", "General"),
        aliases=("Urea",),
        minimum_score=3,
        require_category_match=True,
    ),
    "potassium_chloride_monthly": SeriesHeadlineRule(
        categories=("Fertilizers", "Agriculture", "General"),
        aliases=("Potassium Chloride", "Potash"),
        minimum_score=4,
        require_category_match=True,
    ),
}
...
ENERGY_COMPLEX_RULES: dict[str, SeriesHeadlineRule] = {
    ...
    "jet_fuel_usgc_daily": SeriesHeadlineRule(
        categories=("Oil - Refined Products", "Shipping"),
        aliases=("Jet Fuel", "Aviation Fuel", "Kerosene-Type Jet Fuel"),
        minimum_score=3,
        require_category_match=True,
    ),
    "propane_mont_belvieu_daily": SeriesHeadlineRule(
        categories=("Oil - Refined Products", "Natural Gas"),
        aliases=("Propane", "LPG", "Mont Belvieu"),
        minimum_score=3,
        require_category_match=True,
    ),
    "ulsd_usgc_daily": SeriesHeadlineRule(
        categories=("Oil - Refined Products", "Oil - Crude"),
        aliases=("ULSD", "Diesel", "U.S. Gulf Coast"),
        minimum_score=4,
        require_category_match=True,
    ),
    "ulsd_nyh_daily": SeriesHeadlineRule(
        categories=("Oil - Refined Products", "Oil - Crude"),
        aliases=("ULSD", "Diesel", "New York Harbor"),
        minimum_score=4,
        require_category_match=True,
    ),
    "gasoline_regular_usgc_daily": SeriesHeadlineRule(
        categories=("Oil - Refined Products", "Oil - Crude"),
        aliases=("Gasoline", "Conventional Gasoline", "U.S. Gulf Coast"),
        minimum_score=4,
        require_category_match=True,
    ),
    "gasoline_regular_nyh_daily": SeriesHeadlineRule(
        categories=("Oil - Refined Products", "Oil - Crude"),
        aliases=("Gasoline", "Conventional Gasoline", "New York Harbor"),
        minimum_score=4,
        require_category_match=True,
    ),
    ...
    "coal_south_africa_monthly": SeriesHeadlineRule(
        categories=("Coal",),
        aliases=("South African Coal", "Richards Bay", "Coal"),
        minimum_score=3,
        require_category_match=True,
    ),
}
